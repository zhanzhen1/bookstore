...
// gin 优化根据id获取图书 跳转到更新
func UpdateByID() (handlerFunc gin.HandlerFunc) {
...
// 新增图书界面
func AddBookById() (handlerFunc gin.HandlerFunc) {
	return func(context *gin.Context) {
		bookID := context.Query("bookId")
		book, err := dao.AddByIdBook(bookID)
		if err != nil {
			ReturnErr(context, err)
			return
		}
